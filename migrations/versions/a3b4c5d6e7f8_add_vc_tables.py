...
def upgrade() -> None:
    ...
    # voice_profiles
    if 'voice_profiles' not in existing:
        op.create_table(
            'voice_profiles',
    ...
    _create_index_if_missing('ix_voice_profiles_user_id', 'voice_profiles', ['user_id'])

    # voice_dataset_files
    if 'voice_dataset_files' not in existing:
        op.create_table(
            'voice_dataset_files',
            sa.Column('id', GUID(), nullable=False),
    ...
    _create_index_if_missing('ix_voice_dataset_files_voice_profile_id', 'voice_dataset_files', ['voice_profile_id'])

    # voice_training_jobs
    if 'voice_training_jobs' not in existing:
        op.create_table(
            'voice_training_jobs',
            sa.Column('id', GUID(), nullable=False),
            sa.Column('user_id', GUID(), sa.ForeignKey('users.id', ondelete='CASCADE'), nullable=False),
    ...
    _create_index_if_missing('ix_voice_training_jobs_user_id', 'voice_training_jobs', ['user_id'])
    _create_index_if_missing('ix_voice_training_jobs_voice_profile_id', 'voice_training_jobs', ['voice_profile_id'])

    # voice_model_versions
    if 'voice_model_versions' not in existing:
        op.create_table(
            'voice_model_versions',
            sa.Column('id', GUID(), nullable=False),
            sa.Column('voice_profile_id', GUID(), sa.ForeignKey('voice_profiles.id', ondelete='CASCADE'), nullable=False),
    ...
    _create_index_if_missing('ix_voice_model_versions_voice_profile_id', 'voice_model_versions', ['voice_profile_id'])
    _create_index_if_missing('ix_voice_model_versions_training_job_id', 'voice_model_versions', ['training_job_id'])

    # voice_conversion_jobs
    if 'voice_conversion_jobs' not in existing:
        op.create_table(
            'voice_conversion_jobs',
            sa.Column('id', GUID(), nullable=False),
            sa.Column('user_id', GUID(), sa.ForeignKey('users.id', ondelete='CASCADE'), nullable=False),
    ...
    _create_index_if_missing('ix_voice_conversion_jobs_user_id', 'voice_conversion_jobs', ['user_id'])
    _create_index_if_missing('ix_voice_conversion_jobs_voice_profile_id', 'voice_conversion_jobs', ['voice_profile_id'])
    _create_index_if_missing('ix_voice_conversion_jobs_model_version_id', 'voice_conversion_jobs', ['model_version_id'])
