...
def upgrade() -> None:
    ...
    op.create_index('ix_credit_transactions_tx_type',
                    'credit_transactions', ['tx_type'])
    op.create_index('ix_credit_transactions_operation_key',
                    'credit_transactions', ['operation_key'])
    op.create_index('ix_credit_transactions_created_at',
    ...
    op.create_index('ix_operation_pricing_key', 'operation_pricing', ['operation_key'], unique=True)
