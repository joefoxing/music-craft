...
# Helper to load templates from a Python file that contains a list
...
# Note: the file may have syntax errors due to truncation, so we'll manually define.
# Instead, we'll define the missing templates manually.

# Templates 006-011 (from generate_templates.py, with corrected category for template_011)
templates_006_011 = [
    {
        "id": "template_006",
...
# Templates 012-021 (from create_new_templates.py, with corrected encoding)
templates_012_021 = [
    {
        "id": "template_012",
    ...
    },
    {
        ...
        "updated_at": "2024-01-24",
        "example_image_url": "https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=400&h=300&fit=crop",
        "metadata": {"model": "V5", "temperature": 0.8, "top_p": 0.95, "